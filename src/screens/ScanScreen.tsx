    ...
    >
      ...
      <Animated.View style={[styles.content, contentFadeStyle]}>
        ...
        {!previewImage && !scanResult && (
          <>
            <Animated.View
              style={[styles.scanButtonContainer, scanButtonAnimStyle]}
            >
            ...
            >
              <Text
                style={[styles.galleryButtonText, { color: theme.primary }]}
              >
                Select from Gallery
              </Text>
            </TouchableOpacity>
            ...
            <Animated.View
              style={[instructionScaleStyle, instructionSlideStyle]}
            >
              <View
                style={[
